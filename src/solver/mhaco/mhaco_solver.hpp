...
namespace mokp {
/**********************************************************
 * The MHACO_Solver represents a solver for the
 * Multi-Objective Binary Knapsack Problem using the
 * Multi-Objective Hypervolume-based Ant Colony Optimizer.
 **********************************************************/
