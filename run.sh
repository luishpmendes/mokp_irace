...
declare -A solver_params=(
    ...
    [mhaco]="--memory"
    [nsbrkga1]="--population-size 460 --min-elites-percentage 0.27 --max-elites-percentage 0.27 --mutation-probability 0.18 --mutation-distribution 13.51 --bias-type 2 --crossover-type 1 --num-populations 1 --exchange-interval 0 --num-exchange-individuals 1 --pr-interval 0 --shake-interval 0 --reset-interval 0"
    [nsbrkga2]="--population-size 472 --min-elites-percentage 0.28 --max-elites-percentage 0.78 --mutation-probability 0.98 --mutation-distribution 42.38 --num-elite-parents 2 --bias-type 0 --num-populations 1 --exchange-interval 0 --num-exchange-individuals 1 --pr-interval 0 --shake-interval 0 --reset-interval 0"
    [nsbrkga3]="--population-size 468 --min-elites-percentage 0.08 --max-elites-percentage 0.11 --mutation-probability 0.14 --mutation-distribution 13.95 --crossover-type 1 --exchange-interval 353 --num-exchange-individuals 54 --pr-interval 0 --shake-interval 0 --reset-interval 0"
    [nsbrkga4]="--population-size 416 --min-elites-percentage 0.2 --max-elites-percentage 0.42 --mutation-probability 0.03 --mutation-distribution 4.29 --num-elite-parents 2 --bias-type 5 --diversity-type 1 --exchange-interval 975 --num-exchange-individuals 70 --pr-type 0 --pr-dist-func 0 --pr-percentage 0.26 --pr-interval 626 --shake-interval 0 --reset-interval 0"
    [nsbrkga5]="--population-size 436 --min-elites-percentage 0.02 --max-elites-percentage 0.15 --mutation-probability 0.11 --mutation-distribution 13.66 --num-total-parents 3 --bias-type 2 --diversity-type 3 --exchange-interval 23 --num-exchange-individuals 71 --pr-dist-func 0 --pr-percentage 0.06 --pr-interval 575 --shake-interval 239 --shake-intensity 0.39 --shake-distribution 76.25 --reset-interval 0"
    [nsbrkga6]=""
)
